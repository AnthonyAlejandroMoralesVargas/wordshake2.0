...
const GrammarGame: React.FC<GrammarGameProps> = ({ difficulty, onBack }) => {
  ...
  const submitRecording = () => {
    ...
    if (isAnswerCorrect) {
      // If correct, automatically move to next sentence after showing feedback
      setTimeout(() => {
        ...
        setShowFeedback(false);
        setIsCorrect(null);
      }, 2000); // Show feedback for 2 seconds before continuing
    } else {
      // If incorrect, stay on the same screen and clear recording for retry
      setTimeout(() => {
        setShowFeedback(false);
        setIsCorrect(null);
        setTranscript('');
        ...
        setCountdown(0);
        setRecordingDuration(0);
      }, 3000); // Show error feedback for 3 seconds before clearing
    }
  };
                ...
                <div className={`mt-6 p-6 rounded-lg text-center shadow-lg ${
                  ...
                  {isCorrect ? (
                      <div>
                        ...
                        <h3 className="text-xl font-bold mb-2">Excellent pronunciation!</h3>
                      ...
                      <div>
                        <div className="text-4xl mb-3">💪</div>
                        <h3 className="text-xl font-bold mb-2">Keep trying!</h3>
                        <p className="text-lg font-semibold mb-2">
                          ❌ Pronunciation needs improvement
                        </p>
                        <p className="text-sm text-red-700 mb-3">
                          Listen to the sentence again and practice your pronunciation
                        </p>
                        <div className="text-xs text-red-600">
                          <p>💡 Tips:</p>
                          <ul className="mt-1 space-y-1">
                            <li>• Speak slower and clearer</li>
                            <li>• Pay attention to each word</li>
                            <li>• You can record again or skip this sentence</li>
                          </ul>
                        </div>
                      </div>
                  )}
